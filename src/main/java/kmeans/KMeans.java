...
public class KMeans {
    ...
    /**
     * 
     * Print the cluster results on System.out
     *
     * @param clusters The data result to be printed
     * @return void
     */
    public static void printCluster(Map<Centroid, List<Record>> clusters) {
		// Printing the cluster configuration
		clusters.forEach((key, value) -> {
		    System.out.println("-------------------------- CLUSTER ----------------------------");

		    // Sorting the coordinates to see the most significant tags first.
		    System.out.println(Centroid.sortedCentroid(key)); 
    ...
    /**
     * 
     * Save the cluster results on file
     *
     * @param clusters The data result to be printed
	...
	public static void saveCluster(Map<Centroid, List<Record>> clusters, String filename){
		...
		try {
			...
			System.out.println("Saving cluster data on " + filename);
